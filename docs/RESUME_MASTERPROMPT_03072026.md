...
## 6. PIERWSZY RUCH
1) `git -C "<silly-blackwell>" log --oneline -3` (na gorze docs commit 02/07 wieczor). 2) Przeczytaj pamiec z sekcji 2. 3) Start projektu mozgu CM (sekcja 4) - design, decyzje guzikami, zadnego kodu bez zatwierdzonej architektury. Raportuj, jeden atomowy krok, koncz konkretnym nastepnym krokiem dla Tomasza.
