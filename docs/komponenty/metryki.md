...
**STATUS GOTOWOSCI: CZESCIOWY (X auto przez kolektor; LinkedIn import xlsx reczny do App 2 CMA)** (macierz: docs/GOTOWOSC_PRODUKTU.md; aktualizuj przy kazdej zmianie zachowania)
